...
def set_reanalisys_curr_dims(reanalisys, name, lat_name = 'latitude', lon_name = 'longitude', time_name ='time', v_name = 'v', u_name = 'u'):
    if name == 'CGLO':
        ...
        reanalisys = reanalisys.rename({'yt_ocean': lat_name, 'xt_ocean': lon_name, 'Time':time_name})
